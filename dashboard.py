...
class BackgroundRemoverApp:
    def __init__(self, master):
        ...
        # Tiêu đề
        title = tk.Label(master, text="✨ Công cụ xóa nền ảnh", font=("Helvetica", 16, "bold"), bg="#f0f4f8", fg="#2c3e50")
        title.pack(pady=(20, 10))

        # Khung chứa nút và entry
        btn_frame = tk.Frame(master, bg="#f0f4f8")
        btn_frame.pack(pady=5)

        # Nút chọn thư mục + ô hiển thị path
        ...
        self.btn_process = tk.Button(
            master, text="🚀 Xóa nền ảnh", command=self.process_image,
